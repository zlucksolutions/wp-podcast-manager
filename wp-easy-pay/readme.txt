...
Tags: square, squareup, payment, form, donation
...
Accepts simple and donation payments within minutesâ€œ Frictionless payment process that allows your business to initiate transfers at virtually any time. 
...
== What's new in WP EasyPay version 4.0 - Premium features & Design Options ==
...
[Click here to upgrade to WP EasyPay version 4.0.](https://wpeasypay.com/pricing/)
...
* **Digital Wallet Support** - WP EasyPay supports all major digital payment options including Google Pay and Apple Pay.
...
* **Customer redirection control** - Add redirection time on the thank youÂ page (optional). 
...
WPExperts offer solutions as a third party service provider, we are NOT affiliated, associated, authorized, endorsed by, or in any way officially connected with Square, Inc. The name SquareÂ as well as related marks and images are registered trademarks of Square, Inc.
...
Navigate to the subscriptions tab and cancel any subscription you want by simply choosing the cancelÂ option under the actions drop-down menu.
