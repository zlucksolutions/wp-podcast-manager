...
if ( ! function_exists( 'wpep_add_submenu' ) ) {
	...
	function wpep_add_submenu() {
		...
		add_submenu_page( 'wp_easy_pay', __('Switch to New (Free)','wp_easy_pay'), __('Switch to New (Free)','wp_easy_pay'), 'manage_options', 'wpep_switch_to_new', 'wpep_render_switch_to_new' );
...
function wpep_render_switch_to_new() {

	require_once plugin_dir_path(__FILE__).'views/backend/switch_to_new.php';
}
