	...
	public function createBreakTypeWithHttpInfo( $body ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\CreateBreakTypeResponse'
			);
			if ( ! $response ) {
	...
	public function createShiftWithHttpInfo( $body ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\CreateShiftResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function deleteBreakTypeWithHttpInfo( $id ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\DeleteBreakTypeResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function deleteShiftWithHttpInfo( $id ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\DeleteShiftResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function getBreakTypeWithHttpInfo( $id ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\GetBreakTypeResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function getEmployeeWageWithHttpInfo( $id ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\GetEmployeeWageResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function getShiftWithHttpInfo( $id ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\GetShiftResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function listBreakTypesWithHttpInfo( $location_id = null, $limit = null, $cursor = null ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\ListBreakTypesResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function listEmployeeWagesWithHttpInfo( $employee_id = null, $limit = null, $cursor = null ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\ListEmployeeWagesResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function listWorkweekConfigsWithHttpInfo( $limit = null, $cursor = null ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\ListWorkweekConfigsResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function searchShiftsWithHttpInfo( $body ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\SearchShiftsResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function updateBreakTypeWithHttpInfo( $id, $body ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\UpdateBreakTypeResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function updateShiftWithHttpInfo( $id, $body ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\UpdateShiftResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
	...
	public function updateWorkweekConfigWithHttpInfo( $id, $body ) {
		...
		try {
			list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\SquareConnect\Model\UpdateWorkweekConfigResponse'
			);
			if ( ! $response ) {
				return array( null, $statusCode, $httpHeader );
			}
