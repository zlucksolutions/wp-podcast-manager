...
<head>
    ...
    <title>WP Easy Pay | Order Summary</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #eaeaea;">
    ...
    <![endif]-->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
            style="margin: auto; box-shadow: 0px 0px 40px 0px #e4e4e4;" class="email-container">
            

            <!-- Hero Image, Flush : BEGIN -->
            <tr>
                <td style="background-color: #ffffff;">
                    <img src="[wpep_payment_received_img]" width="600" height="" alt="alt_text" border="0"
