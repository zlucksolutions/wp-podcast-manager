...
<fieldset class="wizard-fieldset show">
	...
	<div id="wpep_personal_information" class="fieldMainWrapper">
		...
		?>
		<input type="hidden" id="wpep_payment_form_type_<?php echo $wpep_current_form_id; ?>" value="subscription"/>
...
<fieldset class="wizard-fieldset orderCompleted blockIfSingle">
	<div class="confIfSingleTop">
		<img src="<?php echo WPEP_ROOT_URL . 'assets/frontend/img/order-done.svg'; ?>" alt="Avatar" width="70"
			 class="doneorder">
