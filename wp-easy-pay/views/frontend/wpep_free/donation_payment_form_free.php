...
<fieldset class="wizard-fieldset">
	<div class="s_ft noMulti">
		<h2><?php _e('Donation Payment','wp_easy_pay');?></h2>
	</div>   
...
<fieldset class="wizard-fieldset orderCompleted blockIfSingle">
	<div class="confIfSingleTop">
		<img src="<?php echo esc_url( WPEP_ROOT_URL . 'assets/frontend/img/order-done.svg' ); ?>" alt="Avatar" width="70"
			 class="doneorder">
		<h2><?php _e('Payment Successful','wp_easy_pay');?> </h2>
	</div>
	<p><?php echo esc_attr($payment_success_message); ?></p>

	<?php if ( '' != $wpep_free_success_url && $redirection_on_success == 'yes' ) { ?>
		<a href="<?php echo esc_url($wpep_free_success_url); ?>" class="form-wizard-submit float-right"><?php echo __($success_btn_label,'wp_easy_pay'); ?></a><br><br>
		<small><?php _e('Page will be redirected in','wp_easy_pay'); ?> <span id="counter"><?php echo __('5','wp_easy_pay'); ?></span> <?php echo __('seconds.','wp_easy_pay'); ?></small>
	<?php } ?>
